		...
		<div class="col-sm-8 col-xs-8">
				<div style="text-align: justify;">
            		<div style="background-color:#fff;padding: 13px;">
            			<strong><a href="#"><span style="font-size: 15px;color:#333">PUBLICATION</span></a></strong>
            			<hr>
            			<strong><a href="#"><span style="color: #337ab7">ICSSE2017 Publication</span></a></strong>
            			<br><br><br>
            			<p>All accepted through a double blind reviewed process full papers will be published in electronically Proceedings with IEEE Catalog Number:</p>
            			<img src="./images/publication1.png"><br><br>
            			<p>Authors will get an CD/USB Proceedings at the conference if they has completed registration and attent conference.</p><br>
            			<p>After the conference, Committee will be sent all papers to IEEE to publish on IEEE XPLORE.</p><br>
            			<strong><p style="color: #002060">ICSSE 2017 IEEE Xplore publication link:</p></strong>
            			<a href="http://ieeexplore.ieee.org/xpl/mostRecentIssue.jsp?punumber=8024255"><span style="color: blue">http://ieeexplore.ieee.org/xpl/mostRecentIssue.jsp?punumber=8024255</span></a><br><br>
            			<a href="#"><img src="./images/others.png"></a>
            			<div style="background-color:#fff;height: 180px">
            			</div>
					</div>
				</div>
		</div>
