		...
		<div class="col-sm-8 col-xs-8">
				<div style="text-align: justify;">
            		<div style="background-color:#fff;padding: 13px;">
            			<strong><p style="font-size: 16px;">PROGRAM</p></strong>
            			<hr>
            			<strong><a href="program.html"><span style="color: #337ab7">OFFICIAL PROGRAM OF ICSSE2017</span></a></strong>
            			<br><br>
            			<div style="text-align:  center;">
            				<strong><span style="color: #c11a1a;font-size: 28px;">OFFICIAL PROGRAM OF ICSSE 2017 </span></strong>
            			</div>
            			<br>
            			<br>
            			<strong><p style="color: #1a6eff;font-size: 30px;">PROGRAM OUTLINE</p></strong>
            			<br>
            			<strong><p style="color: #1a6eff;font-size: 18px;">IMPORTANT INFORMATION FOR ALL PARTICIPANTS</p></strong>
            			<br>
            			<p>Please wear your ICSSE 2017 Conference name tag at all times to gain admission to presentation in break-out rooms.</p>
            			<br>
            			<p>Name tags and tickets are required for Conference Gala Banquet.</p>
            			<br>
            			<p>If you need any formation about the conference, please ask the student helpers or committee members for assistance.</p><br>
            			<img src="./images/program1.png" style ="width:600px">
            			<br>
            			<img src="./images/program2.png" style ="width:600px">
            			<br><br>
            			<strong><p style="color: #1a6eff;font-size: 18px;">DETAILED CONFERENCE PROGRAM</p></strong>
            			<br>
            			<img src="./images/program3.png" style ="width:600px">
            			<br>
            			<img src="./images/program4.png" style ="width:600px">
            			<br><br>
            			<div style="text-align: center">
            			<strong><p style="color: #1a6eff;font-size: 18px;">PLEASE CLICK BELOW BUTTON TO DOWNLOAD<br> DETAILED BREAKOUT SESSIONS PROGRAM</p></strong>
            			<br>
            			<a href="http://icsse2017.hcmute.edu.vn/Resources/Docs/SubDomain/icsse2017/ICSSE%202017%20Official%20Program.pdf">
            				<img src="./images/program5.png">
            			</a><br><br>
            			<img src="./images/program6.png">
            			<br><br>
            			</div>
					</div>
				</div>
