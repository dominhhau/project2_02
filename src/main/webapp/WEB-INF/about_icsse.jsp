...
<body class="mybody">
	...
	<div>
		...
		<div id="id01" class="modal">
		  <form action="trangchu" name="Login" class="modal-content animate" method="post" style="width: 500px;height:500px;text-align:center;margin-left: 400px;">
			<div class="modal-header">
			  <span class="close" title="Close">&times;</span>
			  <p><strong style="font-size:20px">Login</strong></p>
			</div>
...
</html><title>WELLCOME TO ICSSE 2017</title>
	 <meta charset="utf-8">
	  <!-- Khai báo các thư viện css-->
	  <link rel="shortcut icon" type="image/png" href="images/icon.png"/>
	  <meta name="viewport" content="width=device-width, initial-scale=1">
		 ...
		 <nav class="navbar navbar-default">
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="myNavbar">
					<div class="navbar-header">
					<ul class="nav navbar-nav navbar-center">
						<li><a class="glyphicon glyphicon-home" style="text-align: center;" href="icsse2017.html"></a></li>
						<li><a href="icsse2017.html">HOME</a></li>
						<li>
						  <div class="dropdown show">
						  <a class="btn btn-secondary dropdown-toggle" onclick="doimau()" id="about" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="padding: 16px 12px;font-size: 12px;">ABOUT</a>

						  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
						    <a class="dropdown-item" href="about_icsse.html"><span class="glyphicon glyphicon-briefcase" style="color:#847f7f;padding: 10px;font-size: 14px;">&nbsp;ISCCE</span></a>
						    <a class="dropdown-item" href="about_hcmute.html"><span class="glyphicon glyphicon-book" style="color:#847f7f;padding: 10px;font-size: 14px;"">&nbsp;HCMUTE</span></a>
						    <a class="dropdown-item" href="about_committees.html"><span class="glyphicon glyphicon-globe" style="color:#847f7f;padding: 10px;font-size: 14px;">&nbsp;COMMITEES</span></a>
						  </div>
						</div>
						</li>
		...
		<div class="col-sm-8 col-xs-8">
				<div style="text-align: justify;">
            		<div style="background-color:#fff;padding: 13px;">
            			<strong><p style="font-size: 16px;">ISCCE</p></strong>
            			<hr>
            			...
            			<br>
            			<p>The International Conference of System Science and Engineering 2017 (ICSSE 2017) is an international conference that will take place in Ho Chi Minh City during July 21-23, 2017. This event will provide a great opportunity for scientists, engineers, and practitioners from all over the world to present the latest system design concepts, research results, developments and applications, as well as to facilitate interactions between scholars and practitioners. ICSSE 2017 will feature plenary speeches in emerging technology topics given by world renowned scholars. The proceedings of ICSSE 2017 will be published by the IEEE with EI indexing. In addition, selected high-quality papers will be published by special issues of SCI-indexed journals.</p>
	            		<br><br>
	            		<div style="width: 172px;height:50px;">
		            		<a href="http://www.twtasse.org/icsse2016/"><p style="font-size: 16px;background-color: #dbe5f1; color: #002060;">ICSSE 2016 click here</p>
		            		</a>
		            	</div>
		            		<span style="background-color: #ffff00; font-size: 16px; color: #002060;">
		...
		<div class="col-sm-4 col-xs-4">
			...
			<div>
				<ul class="list-group">
					<li class="list-group-item">
						<a href="#">
                        <p class="color_day">Create Date 12/09/2017</p>
                        <span class="color_content">Congratulations! 2017 International Conference on System Science and Engineering (ICSSE) is now published in IEEE Xplore</span></a>
                        <br><span  class="color_day">-------------------------------------------------------</span>
					</li>
					<li class="list-group-item">
						<a href="#">
                        <p class="color_day">Create Date 28/06/2017</p>
                        <span class="color_content">OFFICIAL PROGRAM OF ICSSE2017</span></a>
                        <br><span  class="color_day">-------------------------------------------------------</span>
					</li>
					<li class="list-group-item">
						<a href="#">
